...
class SalObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, depth_root,score, trainsize):
    ...
    def __getitem__(self, index):
        ...
        names = self.images[index].split('/')[-1]
        ...
        return image, gt, depth,score,names
...
def get_loader(image_root, gt_root, depth_root, score,batchsize, trainsize, shuffle=True, num_workers=1, pin_memory=True):
    dataset = SalObjDataset(image_root, gt_root, depth_root,score, trainsize)
